        ...
        if (permissions != null) {
            Set<OakPermission> oakPermissions = Arrays.stream(permissions).map(createPermissionReq -> {
                ...
                oakPermission.setResourceId(oakResource.getId())
                        ...
                        .setValueType(createPermissionReq.getValueType())
                        .setHttpMethod(createPermissionReq.getHttpMethod())
                        .setName(createPermissionReq.getName())
                        .setDescription(createPermissionReq.getDescription())
                        .setOrderCode(createPermissionReq.getOrderCode())
                        .setCreateTime(time)
                        .setLastUpdateTime(time)
                        .setEnabled(true);
