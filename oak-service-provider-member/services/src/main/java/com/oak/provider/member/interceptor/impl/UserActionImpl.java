package com.oak.provider.member.interceptor.impl;
...
import com.oak.provider.member.management.member.req.QueryMemberByOpenIdReq;
import com.oak.provider.member.management.member.req.RegisterMemberFromWxReq;
...
public class UserActionImpl implements AbstractWeChatInterceptor.UserAction {
    ...
    public boolean login(String openId, WxMpUser wxMpUser, HttpServletRequest request, HttpServletResponse response) {
        ...
        //TODO
        String cookieValue = jwtTokenProvider.generateAccessToken(memberInfo.getUserName()).getToken();
