package com.oak.provider.member.services.token;

import com.levin.commons.dao.JpaDao;
import com.levin.commons.dao.UpdateDao;
import com.oak.api.helper.SimpleCommonDaoHelper;
import com.oak.provider.member.entities.MemberToken;
import com.oak.provider.member.services.token.info.MemberTokenInfo;
import com.oak.provider.member.services.token.req.CreateMemberTokenReq;
import com.oak.provider.member.services.token.req.DeleteMemberTokenReq;
import com.oak.provider.member.services.token.req.EditMemberTokenReq;
import com.oak.provider.member.services.token.req.QueryMemberTokenReq;
