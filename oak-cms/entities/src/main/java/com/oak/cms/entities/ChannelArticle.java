...
@Entity
@Table(name = "t_cms_channel_article", indexes = {
        @Index(name = "index_cms_channel_article_channel_id", columnList = "channel_id"),
        @Index(name = "index_cms_channel_article_article_id", columnList = "article_id")
})
@Data
