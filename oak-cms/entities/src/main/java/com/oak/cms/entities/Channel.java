...
@Entity
@Table(name = "t_cms_channel", indexes = {
        @Index(name = "index_cms_channel_code", columnList = "code"),
        @Index(name = "index_cms_channel_name", columnList = "name")
})
@Data
...
public class Channel implements java.io.Serializable {
    ...
    @Column(name = "number_of_articles", nullable = false)
