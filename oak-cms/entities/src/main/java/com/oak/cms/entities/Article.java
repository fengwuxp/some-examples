...
@Entity
@Table(name = "t_cms_article",indexes = {
        @Index(name = "index_cms_article_channel_id", columnList = "channel_id"),
        @Index(name = "index_cms_article_channel_code", columnList = "channel_code"),
        @Index(name = "index_cms_article_title", columnList = "title")
})
@Data
