...
public class OakSpringCodeGeneratorTest {
    ...
    public void testCodegenService() throws Exception {
        ...
        String basePackageName = "com.oak.cms.services.channelimage";
        Map<String, Class> entityMapping = new HashMap<>();
        entityMapping.put("channelimage", ChannelImage.class);
        ServiceModelUtil.entity2ServiceModel(ChannelImage.class, entityMapping, basePackageName, targetFilePath);
    }
}
