...
public final class OakClassTypeConstant {
    ...
    public static final JavaCodeGenClassMeta OAK_QUERY_SORT_TYPE = new JavaCodeGenClassMeta("QueryOrderType", "", ClassType.ENUM, false, null, "com.wuxp.api.model.QueryOrderType", true);
