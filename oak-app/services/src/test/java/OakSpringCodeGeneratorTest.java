...
public class OakSpringCodeGeneratorTest {
    ...
    public void testCodegenService() throws Exception {
        ...
        String basePackageName = "com.oak.app.services.appversion";
        ServiceModelUtil.entity2ServiceModel(AppVersion.class, entityMapping, basePackageName, targetFilePath);
    }
