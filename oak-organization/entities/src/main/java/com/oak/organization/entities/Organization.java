...
@Table(name = "t_organization", indexes = {
        @Index(name = "index_organization_code", columnList = "code"),
        @Index(name = "index_organization_name", columnList = "name"),
        @Index(name = "index_organization_id_path", columnList = "id_path"),
        @Index(name = "index_organization_pinyin_initials", columnList = "pinyin_initials")
})
@Data
