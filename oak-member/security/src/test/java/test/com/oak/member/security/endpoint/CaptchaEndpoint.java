package test.com.oak.member.security.endpoint;
...
public class CaptchaEndpoint {
    ...
    public ApiResp<Map<String, String>> mobileCaptcha(@PathVariable String useType, String mobile) {
        ...
        Map<String, String> map = new HashMap<>(2);
        map.put("data", mobileCaptchaGenerateResult.getValue().getValue());
        return RestfulApiRespFactory.ok(map);
    ...
    public ApiResp<Map<String, Object>> qrCodeCaptcha(@PathVariable String useType) throws Exception {
        QrCodeCaptchaGenerateResult qrCodeCaptchaGenerateResult = qrCodeCaptcha.generate(useType.toUpperCase(), UUID.randomUUID().toString());
//        if (true) {
